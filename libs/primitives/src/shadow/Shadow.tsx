    ...
    if (theme.name == 'light') {
        switch (state) {
            case ControlState.Hovered:
                return '0 2px 4px 0 rgba(0 0 0 / 10%), 0 12px 24px rgb(0 0 0 / 10%)'
            case ControlState.Pressed:
                return '0 2px 4px 0 rgba(0 0 0 / 0%), 0 12px 24px rgb(0 0 0 / 0%)'
            default:
                return '0 2px 4px 0 rgba(0 0 0 / 4%), 0 12px 24px rgb(0 0 0 / 4%)'
        }
    } else {
        switch (state) {
            case ControlState.Hovered:
                return '0 2px 4px 0 rgba(0 0 0 / 20%), 0 12px 24px rgb(0 0 0 / 20%)'
            case ControlState.Pressed:
                return '0 2px 4px 0 rgba(0 0 0 / 0%), 0 12px 24px rgb(0 0 0 / 0%)'
            default:
                return '0 2px 4px 0 rgba(0 0 0 / 10%), 0 12px 24px rgb(0 0 0 / 10%)'
