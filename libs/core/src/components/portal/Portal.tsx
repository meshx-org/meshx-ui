...
type ValidationMap<PortalProps> = any
...
const DISPLAYNAME_PREFIX = `Context`
const Classes = {
    PORTAL: 'portal'
}

const PORTAL_CONTEXT_CLASS_NAME_STRING = "Portal's context API is deprecated."
const PORTAL_LEGACY_CONTEXT_API = "Portal's legacy context API is deprecated."
...
export function Portal(props: PortalProps, legacyContext: PortalLegacyContext = {}) {
    const context = useContext<any>(PortalContext)

    const [hasMounted, setHasMounted] = useState(false)
    const [portalElement, setPortalElement] = useState<HTMLElement>()

    const createContainerElement = useCallback(() => {
